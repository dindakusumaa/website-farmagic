...
<section class="about">
    ...
    <div class="image">
       <img src="images/bg-hidro.svg" alt="">
    </div>
 
    <div class="content">
       <h3 class="about-title">Cerita Sukses Petani Paprika</h3>
       <p>Bandung Barat - Profesi sebagai petani saat ini tak banyak dilirik, terutama oleh generasi muda. Namun, tak demikian bagi Wisnu Saepudin, warga Kampung Baru Nyatu, RW 12, Desa Pasirlangu, Kecamatan Cisarua, Kabupaten Bandung Barat (KBB). Ia mematahkan stigma tersebut.
