...
<section class="heading-link">
   <h3>Berita</h3>
   <p> <a href="index.html">Beranda</a> <a href="berita.php"> / Berita</a></p>
</section>
...
<section class="courses">
   ...
   <div class="box-container">
      <?php
      $sql = 'SELECT * FROM berita JOIN kberita ON kberita.id_kategori = berita.id_kategori ORDER BY id_berita asc';
      ...
      ?>
       <div class="box">
         ...
         <div class="content">
            ...
            <a href="detail.php?id_berita=<?php echo $data->id_berita;?>" class="btnn">Baca selengkapnya</a>
            </div>
         </div>
      </div>
      <?php   
   ...
   <div class="load-more"> 
      <div class="text-bg"> 
         <div class="btnn">Selengkapnya</div> 
      </div> 
   </div>
</section>
<footer>
         ...
         <div class="col-xl-5 col-lg-3 col-md-6 col-sm-6">
          ...
          <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
            ...
            <ul class="link_menu">
               ...
               <li><a href="berita.berita">Berita</a></li>
