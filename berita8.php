...
<section class="about">
    ...
    <div class="image">
       <img src="images/bg-petani.svg" alt="">
    </div>
 
    <div class="content">
       <h3 class="about-title">Petani Hidroponik omzet jutaan rupiah </h3>
       <p>Pandemi membuat Khafidz (25) warga Keamatan Mijen, Kota Semarang berfikir kreatif. Mencari pekerjaan ketika pandemi cukup sulit, itulah yang dirasakan olehnya. Namun, dibalik kesulitan pasti ada kemudahan itula yang dia alami saat ini.
