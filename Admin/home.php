				  ...
				  <nav class="navigation navbar navbar-expand-md navbar-dark ">
					 ...
					 <div class="collapse navbar-collapse" id="navbarsExample04">
						<ul class="navbar-nav mr-auto">
						  <li class="nav-item">
							  <a class="nav-link active" href="../Admin/home.php">Beranda</a>
						   </li>
						   <li class="nav-item ">
...
<body>
    ...
    <div class="container">
                ...
                <a href="fc/chartssss.php" id="generate"> <button type="button" class="btn btn-info">Chart</button></a>
				<a href="form_upload.php" id="generate"> <button type="button" class="btn btn-info">Upload</button></a>
			</div>
		</div>
		</div>
		...
		if($exe=='xlsx'){
			...
			if($upload){
				...
				while (($row = fgetxlsx($open, 1000, ','))!==FALSE ) {
					    $sql = mysqli_query($koneksi,"INSERT INTO tb_slide
...
<div class="container">
                ...
                <table class="table" id="mauexport">
                    <thead>
                        ...
                        <tbody>
                            <?php
                            $sql2   = "select * from slide order by id desc";
                           ...
                           ?>
                            <tr>
                                ...
                                <td scope="row">
                                    ...
                                    <a href="delete.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Yakin mau hapus data?')"><button type="button" class="btn btn-danger">Delete</button></a>            
                                </td>
                            </tr>
