                        ...
                        <div class="row d_flex">
                           <div class="col-md-6">
                              <div class="text-bg">
                                 ...
                                 <h1>Patut dicoba! <br>Popok bayi jadi pupuk</h1>
                                 <p>Kalau berbicara tentang popok bayi, mungkin kamu akan langsung berpikir limbah popok bayi tidak ada gunanya dan sulit terurai. Padahal, ada cara mudah untuk memanfaatkan popok bayi menjadi pupuk.</p>
                                 <a href="berita1.html">Selengkapnya </a>
                              </div>
                           </div> </div>
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure>
                                    <img src="images/popok.svg" alt="#"/>
                                    <h3>01</h3>
                                 </figure>
                              </div>
                           </div>
                     ...
                     <div class="carousel-caption">
                        <div class="row d_flex">
                           <div class="col-md-6">
                              <div class="text-bg">
                                 <div class="text-banner">
                                 <h1>Kotoran Manusia Bisa Jadi Pupuk</h1>
                                 <p>Selama ini mungkin kamu berpikir bahwa kotoran manusia tidak ada gunanya bahkan hanya dapat mencemarkan lingkungan saja dengan bau yang tidak sedap. Padahal kamu bisa saja membuat fasilitas toilet kompos.</p>
                                 <a href="berita2.html">Selengkapnya </a>
                              </div>
                           </div> </div>
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure>
                                    <img src="images/pup.svg" alt="#"/>
                                    <h3>02</h3>
                                 </figure>
                              </div>
                           </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <div id="serv_hover" class="services_box">
                        ...
                        <h3>Fakta Menarik</h3>
                        <a class="right_irro" href="fakta.html"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div id="serv_hover" class="services_box">
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="titlepage">
               ...
               <p>Berbagi pengalaman anda menjadi petani milenial!</p>
            </div>
         </div>
      </div>
      <div class="row">
         <div class="col-md-6 ">
            <div class="test_box margin_bottom">
               <p>Pengalamanku menjadi petani sudah cukup lama sejak tahun 2015. Meski minat bertani semakin menurun, saya sebagai generasi milenial ingin ikut menyelamatkan pangan di Indonesia</p>
               <div class="test_icon">
                  <i><img src="images/avatar.png" alt="#"/></i>
                  <h4>Yourdan Saputra<br> <span class="yellow">Petani Milenial</span></h4>
               </div>
            </div>
         </div>
         <div class="col-md-6">
            <div class="test_box">
               <p>Petani milenial adalah bertani dan 
                  mengembangkan usaha pertanian hingga sukses. aku memliki ketertarikan dalam bidang pertanian, dan ingin membangun pertanian di Jawa Barat yang lebih baik. </p>
               <div class="test_icon">
                  <i><img src="images/cos.png" alt="#"/></i>
                  <h4>Fiona Kharismatunnisa<br> <span class="yellow">Petani Mileniall</span></h4>
               </div>
            </div>
         </div>
      </div>
